...
var file_nuntio_users_v1alpha1_users_public_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x69, 0x72, 0x32, 0xa3, 0x08, 0x0a, 0x0d, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x6e, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12,
	...
	0x74, 0x1a, 0x31, 0x2e, 0x6e, 0x75, 0x6e, 0x74, 0x69, 0x6f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x68, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x2e, 0x2e,
	...
	0x69, 0x63, 0x65, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2f, 0x2e,
	0x6e, 0x75, 0x6e, 0x74, 0x69, 0x6f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x76, 0x31, 0x61,
	0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
	0x12, 0x71, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x31, 0x2e, 0x6e, 0x75, 0x6e,
...
var file_nuntio_users_v1alpha1_users_public_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_nuntio_users_v1alpha1_users_public_proto_goTypes = []interface{}{
	...
	(*UserIdentifier)(nil),                              // 16: nuntio.users.v1alpha1.UserIdentifier
	(*TokenPair)(nil),                                   // 17: nuntio.users.v1alpha1.TokenPair
	(*User)(nil),                                        // 18: nuntio.users.v1alpha1.User
	(*VerificationCode)(nil),                            // 19: nuntio.users.v1alpha1.VerificationCode
}
var file_nuntio_users_v1alpha1_users_public_proto_depIdxs = []int32{
	16, // 0: nuntio.users.v1alpha1.PublicServiceLoginRequest.identifier:type_name -> nuntio.users.v1alpha1.UserIdentifier
	17, // 1: nuntio.users.v1alpha1.PublicServiceLoginResponse.token_pair:type_name -> nuntio.users.v1alpha1.TokenPair
	18, // 2: nuntio.users.v1alpha1.PublicServiceGetResponse.user:type_name -> nuntio.users.v1alpha1.User
	18, // 3: nuntio.users.v1alpha1.PublicServiceCreateRequest.user:type_name -> nuntio.users.v1alpha1.User
	19, // 4: nuntio.users.v1alpha1.PublicServiceSendResetPasswordEmailResponse.verification_code:type_name -> nuntio.users.v1alpha1.VerificationCode
	19, // 5: nuntio.users.v1alpha1.PublicServiceSendResetPasswordTextResponse.verification_code:type_name -> nuntio.users.v1alpha1.VerificationCode
	16, // 6: nuntio.users.v1alpha1.PublicServiceResetPasswordRequest.identifier:type_name -> nuntio.users.v1alpha1.UserIdentifier
	17, // 7: nuntio.users.v1alpha1.PublicServiceRefreshTokenResponse.token_pair:type_name -> nuntio.users.v1alpha1.TokenPair
	0,  // 8: nuntio.users.v1alpha1.PublicService.Login:input_type -> nuntio.users.v1alpha1.PublicServiceLoginRequest
	2,  // 9: nuntio.users.v1alpha1.PublicService.Get:input_type -> nuntio.users.v1alpha1.PublicServiceGetRequest
	4,  // 10: nuntio.users.v1alpha1.PublicService.Create:input_type -> nuntio.users.v1alpha1.PublicServiceCreateRequest
	6,  // 11: nuntio.users.v1alpha1.PublicService.SendResetPasswordEmail:input_type -> nuntio.users.v1alpha1.PublicServiceSendResetPasswordEmailRequest
	8,  // 12: nuntio.users.v1alpha1.PublicService.SendResetPasswordText:input_type -> nuntio.users.v1alpha1.PublicServiceSendResetPasswordTextRequest
	10, // 13: nuntio.users.v1alpha1.PublicService.ResetPassword:input_type -> nuntio.users.v1alpha1.PublicServiceResetPasswordRequest
	12, // 14: nuntio.users.v1alpha1.PublicService.Delete:input_type -> nuntio.users.v1alpha1.PublicServiceDeleteRequest
	14, // 15: nuntio.users.v1alpha1.PublicService.RefreshToken:input_type -> nuntio.users.v1alpha1.PublicServiceRefreshTokenRequest
	1,  // 16: nuntio.users.v1alpha1.PublicService.Login:output_type -> nuntio.users.v1alpha1.PublicServiceLoginResponse
	3,  // 17: nuntio.users.v1alpha1.PublicService.Get:output_type -> nuntio.users.v1alpha1.PublicServiceGetResponse
	5,  // 18: nuntio.users.v1alpha1.PublicService.Create:output_type -> nuntio.users.v1alpha1.PublicServiceCreateResponse
	7,  // 19: nuntio.users.v1alpha1.PublicService.SendResetPasswordEmail:output_type -> nuntio.users.v1alpha1.PublicServiceSendResetPasswordEmailResponse
	9,  // 20: nuntio.users.v1alpha1.PublicService.SendResetPasswordText:output_type -> nuntio.users.v1alpha1.PublicServiceSendResetPasswordTextResponse
	11, // 21: nuntio.users.v1alpha1.PublicService.ResetPassword:output_type -> nuntio.users.v1alpha1.PublicServiceResetPasswordResponse
	13, // 22: nuntio.users.v1alpha1.PublicService.Delete:output_type -> nuntio.users.v1alpha1.PublicServiceDeleteResponse
	15, // 23: nuntio.users.v1alpha1.PublicService.RefreshToken:output_type -> nuntio.users.v1alpha1.PublicServiceRefreshTokenResponse
