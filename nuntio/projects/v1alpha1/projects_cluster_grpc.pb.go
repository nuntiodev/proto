...
type ClusterServiceClient interface {
	...
	Ping(ctx context.Context, in *ClusterServicePingRequest, opts ...grpc.CallOption) (*ClusterServicePingResponse, error)
...
func (c *clusterServiceClient) Ping(ctx context.Context, in *ClusterServicePingRequest, opts ...grpc.CallOption) (*ClusterServicePingResponse, error) {
	out := new(ClusterServicePingResponse)
	err := c.cc.Invoke(ctx, "/nuntio.projects.v1alpha1.ClusterService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterServiceClient) Get(ctx context.Context, in *ClusterServiceGetRequest, opts ...grpc.CallOption) (*ClusterServiceGetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nuntio.projects.v1alpha1.ClusterService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ClusterServiceServer interface {
	// Ping checks if a service is live
	Ping(context.Context, *ClusterServicePingRequest) (*ClusterServicePingResponse, error)
	// Get returns info about the cluster and what infrastructure is available.
...
func (UnimplementedClusterServiceServer) Ping(context.Context, *ClusterServicePingRequest) (*ClusterServicePingResponse, error) {
...
func _ClusterService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClusterServicePingRequest)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nuntio.projects.v1alpha1.ClusterService/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterServiceServer).Ping(ctx, req.(*ClusterServicePingRequest))
	}
...
func _ClusterService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nuntio.projects.v1alpha1.ClusterService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ClusterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nuntio.projects.v1alpha1.ClusterService",
	...
	Metadata: "nuntio/projects/v1alpha1/projects_cluster.proto",
}
