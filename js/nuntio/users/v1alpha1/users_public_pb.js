...
goog.exportSymbol('proto.nuntio.users.v1alpha1.PublicServicePingRequest', null, global);
goog.exportSymbol('proto.nuntio.users.v1alpha1.PublicServicePingResponse', null, global);
 ...
 * @constructor
 */
proto.nuntio.users.v1alpha1.PublicServicePingRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.nuntio.users.v1alpha1.PublicServicePingRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.nuntio.users.v1alpha1.PublicServicePingRequest.displayName = 'proto.nuntio.users.v1alpha1.PublicServicePingRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.nuntio.users.v1alpha1.PublicServicePingResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.nuntio.users.v1alpha1.PublicServicePingResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.nuntio.users.v1alpha1.PublicServicePingResponse.displayName = 'proto.nuntio.users.v1alpha1.PublicServicePingResponse';
}
...
proto.nuntio.users.v1alpha1.PublicServiceRegisterRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    userIdentifier: (f = msg.getUserIdentifier()) && nuntio_users_v1alpha1_users_messages_pb.UserIdentifier.toObject(includeInstance, f),
    password: jspb.Message.getFieldWithDefault(msg, 2, ""),
    namespace: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
...
/**
 * optional UserIdentifier user_identifier = 1;
 * @return {?proto.nuntio.users.v1alpha1.UserIdentifier}
 */
proto.nuntio.users.v1alpha1.PublicServiceRegisterRequest.prototype.getUserIdentifier = function() {
  return /** @type{?proto.nuntio.users.v1alpha1.UserIdentifier} */ (
    jspb.Message.getWrapperField(this, nuntio_users_v1alpha1_users_messages_pb.UserIdentifier, 1));
};
...
*/
proto.nuntio.users.v1alpha1.PublicServiceRegisterRequest.prototype.setUserIdentifier = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.nuntio.users.v1alpha1.PublicServiceRegisterRequest} returns this
 */
proto.nuntio.users.v1alpha1.PublicServiceRegisterRequest.prototype.clearUserIdentifier = function() {
  return this.setUserIdentifier(undefined);
};
 ...
 * @return {boolean}
 */
proto.nuntio.users.v1alpha1.PublicServiceRegisterRequest.prototype.hasUserIdentifier = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.nuntio.users.v1alpha1.PublicServiceRegisterRequest.prototype.getPassword = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.nuntio.users.v1alpha1.PublicServiceRegisterRequest} returns this
 */
proto.nuntio.users.v1alpha1.PublicServiceRegisterRequest.prototype.setPassword = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.nuntio.users.v1alpha1.PublicServicePingRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.nuntio.users.v1alpha1.PublicServicePingRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.nuntio.users.v1alpha1.PublicServicePingRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nuntio.users.v1alpha1.PublicServicePingRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.nuntio.users.v1alpha1.PublicServicePingRequest}
 */
proto.nuntio.users.v1alpha1.PublicServicePingRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.nuntio.users.v1alpha1.PublicServicePingRequest;
  return proto.nuntio.users.v1alpha1.PublicServicePingRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.nuntio.users.v1alpha1.PublicServicePingRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.nuntio.users.v1alpha1.PublicServicePingRequest}
 */
proto.nuntio.users.v1alpha1.PublicServicePingRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.nuntio.users.v1alpha1.PublicServicePingRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.nuntio.users.v1alpha1.PublicServicePingRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.nuntio.users.v1alpha1.PublicServicePingRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nuntio.users.v1alpha1.PublicServicePingRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {!Object}
 */
proto.nuntio.users.v1alpha1.PublicServicePingResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.nuntio.users.v1alpha1.PublicServicePingResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.nuntio.users.v1alpha1.PublicServicePingResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nuntio.users.v1alpha1.PublicServicePingResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.nuntio.users.v1alpha1.PublicServicePingResponse}
 */
proto.nuntio.users.v1alpha1.PublicServicePingResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.nuntio.users.v1alpha1.PublicServicePingResponse;
  return proto.nuntio.users.v1alpha1.PublicServicePingResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.nuntio.users.v1alpha1.PublicServicePingResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.nuntio.users.v1alpha1.PublicServicePingResponse}
 */
proto.nuntio.users.v1alpha1.PublicServicePingResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.nuntio.users.v1alpha1.PublicServicePingResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.nuntio.users.v1alpha1.PublicServicePingResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.nuntio.users.v1alpha1.PublicServicePingResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nuntio.users.v1alpha1.PublicServicePingResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
